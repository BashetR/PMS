...
export class ResetPassword implements OnInit {
  ...
  constructor(private fb: FormBuilder, private supabase: SupabaseService, private router: Router, private titleService: TitleService, private formValidator: FormValidationService) { }
